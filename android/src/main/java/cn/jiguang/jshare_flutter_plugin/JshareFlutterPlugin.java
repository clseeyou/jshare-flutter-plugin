 ...
 * Description
 */
public class JshareFlutterPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onAttachedToEngine(FlutterPluginBinding flutterPluginBinding) {
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "jshare_flutter_plugin");
